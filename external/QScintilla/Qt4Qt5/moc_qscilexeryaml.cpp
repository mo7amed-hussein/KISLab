...
struct qt_meta_stringdata_QsciLexerYAML_t {
    QByteArrayData data[4];
    char stringdata[37];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_QsciLexerYAML_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_QsciLexerYAML_t qt_meta_stringdata_QsciLexerYAML = {
    {
...
QT_MOC_LITERAL(3, 31, 4)
    ...
    "QsciLexerYAML\0setFoldComments\0\0fold\0"
};
...
const QMetaObject QsciLexerYAML::staticMetaObject = {
    { &QsciLexer::staticMetaObject, qt_meta_stringdata_QsciLexerYAML.data,
      qt_meta_data_QsciLexerYAML,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerYAML.stringdata))
