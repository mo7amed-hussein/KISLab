...
struct qt_meta_stringdata_QsciLexerPOV_t {
    QByteArrayData data[6];
    char stringdata[69];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_QsciLexerPOV_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_QsciLexerPOV_t qt_meta_stringdata_QsciLexerPOV = {
    {
...
QT_MOC_LITERAL(5, 50, 17)
    ...
    "QsciLexerPOV\0setFoldComments\0\0fold\0"
    "setFoldCompact\0setFoldDirectives\0"
};
...
const QMetaObject QsciLexerPOV::staticMetaObject = {
    { &QsciLexer::staticMetaObject, qt_meta_stringdata_QsciLexerPOV.data,
      qt_meta_data_QsciLexerPOV,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerPOV.stringdata))
