...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QsciLexerCSS_t, stringdata) + ofs \
...
void QsciLexerCSS::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QsciLexerCSS *_t = static_cast<QsciLexerCSS *>(_o);
        switch (_id) {
...
const QMetaObject QsciLexerCSS::staticMetaObject = {
    { &QsciLexer::staticMetaObject, qt_meta_stringdata_QsciLexerCSS.data,
      qt_meta_data_QsciLexerCSS,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerCSS.stringdata))
