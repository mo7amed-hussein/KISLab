...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QsciLexerCMake_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 30, 4)
    ...
    "QsciLexerCMake\0setFoldAtElse\0\0fold\0"
};
...
const QMetaObject QsciLexerCMake::staticMetaObject = {
    { &QsciLexer::staticMetaObject, qt_meta_stringdata_QsciLexerCMake.data,
      qt_meta_data_QsciLexerCMake,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerCMake.stringdata))
