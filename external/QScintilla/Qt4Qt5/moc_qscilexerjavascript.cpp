...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QsciLexerJavaScript_t, stringdata) + ofs \
...
const QMetaObject QsciLexerJavaScript::staticMetaObject = {
    { &QsciLexerCPP::staticMetaObject, qt_meta_stringdata_QsciLexerJavaScript.data,
      qt_meta_data_QsciLexerJavaScript,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerJavaScript.stringdata))
