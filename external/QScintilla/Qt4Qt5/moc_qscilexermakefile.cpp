...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QsciLexerMakefile_t, stringdata) + ofs \
...
const QMetaObject QsciLexerMakefile::staticMetaObject = {
    { &QsciLexer::staticMetaObject, qt_meta_stringdata_QsciLexerMakefile.data,
      qt_meta_data_QsciLexerMakefile,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerMakefile.stringdata))
