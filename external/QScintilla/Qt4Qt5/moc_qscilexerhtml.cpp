...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QsciLexerHTML_t, stringdata) + ofs \
...
const QMetaObject QsciLexerHTML::staticMetaObject = {
    { &QsciLexer::staticMetaObject, qt_meta_stringdata_QsciLexerHTML.data,
      qt_meta_data_QsciLexerHTML,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerHTML.stringdata))
