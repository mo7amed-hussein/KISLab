...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QsciLexerLua_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 29, 4)
    ...
    "QsciLexerLua\0setFoldCompact\0\0fold\0"
};
...
const QMetaObject QsciLexerLua::staticMetaObject = {
    { &QsciLexer::staticMetaObject, qt_meta_stringdata_QsciLexerLua.data,
      qt_meta_data_QsciLexerLua,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerLua.stringdata))
