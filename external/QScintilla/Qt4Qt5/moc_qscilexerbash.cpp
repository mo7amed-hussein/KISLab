...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QsciLexerBash_t, stringdata) + ofs \
...
void QsciLexerBash::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QsciLexerBash *_t = static_cast<QsciLexerBash *>(_o);
        switch (_id) {
...
const QMetaObject QsciLexerBash::staticMetaObject = {
    { &QsciLexer::staticMetaObject, qt_meta_stringdata_QsciLexerBash.data,
      qt_meta_data_QsciLexerBash,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerBash.stringdata))
