...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QsciLexerPO_t, stringdata) + ofs \
...
void QsciLexerPO::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        QsciLexerPO *_t = static_cast<QsciLexerPO *>(_o);
        switch (_id) {
...
const QMetaObject QsciLexerPO::staticMetaObject = {
    { &QsciLexer::staticMetaObject, qt_meta_stringdata_QsciLexerPO.data,
      qt_meta_data_QsciLexerPO,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerPO.stringdata))
        return static_cast<void*>(const_cast< QsciLexerPO*>(this));
