...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QsciLexerDiff_t, stringdata) + ofs \
...
const QMetaObject QsciLexerDiff::staticMetaObject = {
    { &QsciLexer::staticMetaObject, qt_meta_stringdata_QsciLexerDiff.data,
      qt_meta_data_QsciLexerDiff,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerDiff.stringdata))
        return static_cast<void*>(const_cast< QsciLexerDiff*>(this));
