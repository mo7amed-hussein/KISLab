...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QsciLexerCoffeeScript_t, stringdata) + ofs \
...
const QMetaObject QsciLexerCoffeeScript::staticMetaObject = {
    { &QsciLexer::staticMetaObject, qt_meta_stringdata_QsciLexerCoffeeScript.data,
      qt_meta_data_QsciLexerCoffeeScript,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerCoffeeScript.stringdata))
        return static_cast<void*>(const_cast< QsciLexerCoffeeScript*>(this));
