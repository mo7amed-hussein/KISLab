...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_QsciScintillaQt_t, stringdata) + ofs \
...
const QMetaObject QsciScintillaQt::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QsciScintillaQt.data,
      qt_meta_data_QsciScintillaQt,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QsciScintillaQt.stringdata))
