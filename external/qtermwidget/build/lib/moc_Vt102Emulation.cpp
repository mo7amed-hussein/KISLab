...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Konsole__Vt102Emulation_t, stringdata) + ofs \
...
QT_MOC_LITERAL(14, 138, 11)
    ...
    "buttons\0column\0line\0eventType\0updateTitle\0"
};
...
const QMetaObject Konsole::Vt102Emulation::staticMetaObject = {
    { &Emulation::staticMetaObject, qt_meta_stringdata_Konsole__Vt102Emulation.data,
      qt_meta_data_Konsole__Vt102Emulation,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Konsole__Vt102Emulation.stringdata))
