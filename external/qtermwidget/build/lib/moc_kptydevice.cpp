...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_KPtyDevice_t, stringdata) + ofs \
...
void KPtyDevice::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        KPtyDevice *_t = static_cast<KPtyDevice *>(_o);
        switch (_id) {
        ...
        {
            typedef void (KPtyDevice::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&KPtyDevice::readEof)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject KPtyDevice::staticMetaObject = {
    { &QIODevice::staticMetaObject, qt_meta_stringdata_KPtyDevice.data,
      qt_meta_data_KPtyDevice,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_KPtyDevice.stringdata))
        return static_cast<void*>(const_cast< KPtyDevice*>(this));
    if (!strcmp(_clname, "KPty"))
        return static_cast< KPty*>(const_cast< KPtyDevice*>(this));
