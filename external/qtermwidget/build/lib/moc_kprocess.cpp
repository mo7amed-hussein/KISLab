...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_KProcess_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 27, 16)
    ...
    "KProcess\0_k_forwardStdout\0\0_k_forwardStderr\0"
};
...
const QMetaObject KProcess::staticMetaObject = {
    { &QProcess::staticMetaObject, qt_meta_stringdata_KProcess.data,
      qt_meta_data_KProcess,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_KProcess.stringdata))
        return static_cast<void*>(const_cast< KProcess*>(this));
