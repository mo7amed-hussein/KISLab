...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_Konsole__UrlFilter_t, stringdata) + ofs \
...
void Konsole::UrlFilter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (UrlFilter::*_t)(const QUrl & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&UrlFilter::activated)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Konsole::UrlFilter::staticMetaObject = {
    { &RegExpFilter::staticMetaObject, qt_meta_stringdata_Konsole__UrlFilter.data,
      qt_meta_data_Konsole__UrlFilter,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Konsole__UrlFilter.stringdata))
        return static_cast<void*>(const_cast< UrlFilter*>(this));
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_Konsole__FilterObject_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
...
void Konsole::FilterObject::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (FilterObject::*_t)(const QUrl & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FilterObject::activated)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject Konsole::FilterObject::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_Konsole__FilterObject.data,
      qt_meta_data_Konsole__FilterObject,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Konsole__FilterObject.stringdata))
        return static_cast<void*>(const_cast< FilterObject*>(this));
