...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_HistorySearch_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 66, 12)
    ...
    "startLine\0endColumn\0endLine\0noMatchFound\0"
};
...
void HistorySearch::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (HistorySearch::*_t)(int , int , int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HistorySearch::matchFound)) {
                *result = 0;
            }
        }
        {
            typedef void (HistorySearch::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&HistorySearch::noMatchFound)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject HistorySearch::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_HistorySearch.data,
      qt_meta_data_HistorySearch,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_HistorySearch.stringdata))
